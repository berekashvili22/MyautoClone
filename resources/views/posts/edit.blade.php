...
@section('content')
<div class="create-post-cont container border" style="padding-top: 100px;">
   <form action="{{ route('post.update', $post->id) }}" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        <div class="col-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="deal_type" id="dealType1" value="sale" @if ($post->deal_type == "sale") checked @endif>
                <label class="form-check-label" for="dealType1">
                  For sale
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="deal_type" id="dealType2" value="rent" @if ($post->deal_type == "rent") checked @endif>
        ...
        <div class="col-3 mr-5">
            ...
            <div class="row pl-2 mt-3">
                ...
                <select id="inputState" class="form-control" name="prod_date">
                    <option selected value="{{ $post->prod_date }}">{{ $post->prod_date }}</option>
            ...
            <div class="row pl-2 mt-3">     
                ...
                <input type="text" class="form-control" id="inputMileage" name="mileage" value="{{ $post->mileage }}">
                @error('mileage')
                    <strong class="error" style="color: red; font-size: 12px;">{{ $message }}</strong>
                @enderror
            </div>
            <div class="row pl-2 mt-3">
                ...
                <select id="gearboxType" class="form-control" name="gearbox_type">
                    <option selected value="{{ $post->gearbox_type }}">{{ $post->gearbox_type }}</option>
        ...
        <div class="col-3 ml-5">
            <div class="row pl-2 ">
                ...
                <select id="inputState" class="form-control" name="cylinders">
                    <option selected value="{{ $post->cylinders }}">{{ $post->cylinders }}</option>
            ...
            <div class="row pl-2 mt-3">
                ...
                <select id="inputState" class="form-control" name="doors">
                    <option selected value="{{ $post->doors }}">{{ $post->doors }}</option>
            ...
            <div class="row pl-2 mt-3">
                ...
                <select id="fuelType" class="form-control" name="fuel_type">
                    <option selected value="{{ $post->fuel_type }}">{{ $post->fuel_type }}</option>
            ...
            <div class="row pl-2 mt-3">
                ...
                <select id="driveWheels" class="form-control" name="drive_wheels">
                    <option selected value="{{ $post->drive_wheels }}">{{ $post->drive_wheels }}</option>
            ...
            <div class="row pl-2 mt-3">
                ...
                <select id="driveWheels" class="form-control" name="color">
                    <option selected value="{{ $post->color }}">{{ $post->color }}</option>
            ...
            <div class="row mt-3">
                <div class="col-9">
                    ...
                    <select id="engineVolume" class="form-control" name="engine_volume">
                        <option selected value="{{ $post->engine_volume }}">{{ $post->engine_volume }}</option>
                ...
                <div class="col-3 mt-5">
                    ...
                    <input class="form-check-input" type="checkbox" name="turbo" id="HasTurbo" value="1" @if ($post->turbo == 1) checked @endif>
    ...
    <div class="row mt-2 ml-2">
        <div class="col-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="wheel" id="wheelSide" value="L" @if ($post->wheel == 'L') checked @endif>
                <label class="form-check-label" for="wheelSide">
                  Left
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="wheel" id="WheelSide" value="R" @if ($post->wheel == 'R') checked @endif>
                <label class="form-check-label" for="WheelSide">
                  Right
                </label>
            </div>
    ...
    <div class="row mt-1">
        <div class="col-3 ml-5">
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="hydraulics" id="Hashydraulics" value="1" @if ($post->hydraulics == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="rims" id="Hasrims" value="1" @if ($post->rims == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="el_window" id="Hasel_window" value="1" @if ($post->el_window == 1) checked @endif>
        ...
        <div class="col-3">
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="climate_control" id="Hasclimate_control" value="1" @if ($post->climate_control == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="seat_heater" id="Hasseat_heater" value="1" @if ($post->seat_heater == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="central_lock" id="Hascentral_lock" value="1" @if ($post->central_lock == 1) checked @endif>
        ...
        <div class="col-3">
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="alarm" id="Hasalarm" value="1" @if ($post->alarm == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="bord_computer" id="Hasbord_computer" value="1" @if ($post->board_computer == 1) checked @endif>
            ...
            <div class="row">
                ...
                <input class="form-check-input" type="checkbox" name="navigation" id="Hasnavigation" value="1" @if ($post->navigation == 1) checked @endif>
    ...
    <div class="row p-3">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Add description here..." 
    ...
    <div class="row">
        <div class="col-4 ml-2 mr-5">
            ...
            <div class="row pl-2 mt-3">     
                ...
                <input type="text" class="form-control" id="inputphone" name="phone" value="{{ $post->phone }}">
                @error('phone')
                    <strong class="cylinders" style="color: red; font-size: 12px;">{{ $message }}</strong>
                @enderror
            </div>
            <div class="row pl-2 mt-3" style="max-width: 150px;">     
                ...
                <input type="text" class="form-control" id="inputPrice" name="price" value="{{ $post->price }}">
                @error('price')
                    <strong class="cylinders" style="color: red; font-size: 12px;">{{ $message }}</strong>
                @enderror
            </div>            
        ...
        <div class="col-4 mt-3 mb-5">
            ...
            <div class="row mt-5 pt-2 ml-1">
                ...
                <div class="form-check mr-2">
                    <input class="form-check-input" type="radio" name="customs" id="customs" value="1" @if ($post->customs == 1) checked @endif>
                    <label class="form-check-label" for="customs">
                        Custom cleared
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="customs" id="customs" value="0" @if ($post->navigation == 0) checked @endif >
                    <label class="form-check-label" for="customs">
                        Before Customs
                    </label>
                </div>
